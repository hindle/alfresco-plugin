...
class AlfrescoWorkshopSeaside {
    ...
    public function saveData() {
				...
				$cardName = $this->schoolName . ' - Seaside';
        ...
        try {
            ...
            throw $e;
				...
				try {
					$trello->updateWorkshopCustomFields($cardId, AlfrescoTrello::WORKSHOP_TYPE_SEASIDE, $this->contactName, $this->contactEmail, $this->adminName, $this->adminEmail, $this->schoolName, $this->schoolAddress, $this->schoolPostcode);
				} catch (Exception $e) {
					throw $e;
				}
