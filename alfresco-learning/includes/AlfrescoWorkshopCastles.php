...
class AlfrescoWorkshopCastles {
    ...
    public function saveData() {
        ...
        try {
            $trello->createWorkshopCard($this->schoolName, 'Castles', $trelloContent);
        } catch (Exception $e) {
            throw $e;
        }
    ...
    private function sendEmail() {
        ...
        $subject = "New Castles workshop enquiry - " . $this->schoolName;
