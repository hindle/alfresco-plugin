...
class AlfrescoWorkshopTrelloCard
{
    ...
    public function __construct($customFieldDetails)
    {
        ...
        $this->adminName = $customFieldDetails[AlfrescoTrello::WORKSHOP_CARD_ADMIN_NAME_FIELD_ID]['text'] ?? '';
        $this->adminEmail = $customFieldDetails[AlfrescoTrello::WORKSHOP_CARD_ADMIN_EMAIL_FIELD_ID]['text'] ?? '';
        $this->teacherName = $customFieldDetails[AlfrescoTrello::WORKSHOP_CARD_TEACHER_NAME_FIELD_ID]['text'] ?? '';
        $this->teacherEmail = $customFieldDetails[AlfrescoTrello::WORKSHOP_CARD_TEACHER_EMAIL_FIELD_ID]['text'] ?? '';
        $this->schoolName = $customFieldDetails[AlfrescoTrello::WORKSHOP_CARD_SCHOOL_NAME_FIELD_ID]['text'] ?? '';
        $this->schoolAddress = $customFieldDetails[AlfrescoTrello::WORKSHOP_CARD_SCHOOL_ADDRESS_FIELD_ID]['text'] ?? '';
        $this->schoolPostcode = $customFieldDetails[AlfrescoTrello::WORKSHOP_CARD_SCHOOL_POSTCODE_FIELD_ID]['text'] ?? '';
        $this->session1 = $customFieldDetails[AlfrescoTrello::WORKSHOP_CARD_SESSION_1_FIELD_ID]['text'] ?? '';
        $this->session2 = $customFieldDetails[AlfrescoTrello::WORKSHOP_CARD_SESSION_2_FIELD_ID]['text'] ?? '';
        $this->session3 = $customFieldDetails[AlfrescoTrello::WORKSHOP_CARD_SESSION_3_FIELD_ID]['text'] ?? '';

        $rawDate = $customFieldDetails[AlfrescoTrello::WORKSHOP_CARD_DATE_FIELD_ID]['date'];
        $this->date = date("d/m/Y", strtotime($rawDate));

        $this->workshopType = $customFieldDetails[AlfrescoTrello::WORKSHOP_CARD_WORKSHOP_TYPE_FIELD_ID]['text'];
